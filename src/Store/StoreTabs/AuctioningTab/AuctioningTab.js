...
const headers = ['Current', 'Achieved', 'Drafts', 'Closed', 'Pending',
    'Shipped', 'Participated',]


export const AuctioningTab = () => {
    ...
    useEffect(() => {
        scrollViewRef.current?.scrollTo({ x: isActive < 3 ? isActive * -150 : isActive * 50 })
    }, [isActive])
                        ...
                        return (
                            <View>
                                <TouchableOpacity
                                    ...
                                    key={item}
                                    style={[styles.headerItem, { backgroundColor: isActive == index ? '#fff' : '#fff' }]}>
                                    <AppText style={{
                                        color: isActive == index ? colors.theme : colors.lightText,
                                        padding: 3,
                                        // fontSize: 13
                                    }}>{item}</AppText>
                                </TouchableOpacity>
