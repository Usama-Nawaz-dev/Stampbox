...
export default async function getPermissionAsync(
  ...
  //   Alert.alert(
  //     'Cannot be done 😞',
  //     `If you would like to use this feature, you'll need to enable the permission in your phone settings.`,
  //     [
  //       {
  //         text: "Let's go!",
  //         onPress: () => console.log('per'),
  //       },
...
export async function getLocationAsync(
  onSend: (locations: { location: '' }[]) => void,
) {
